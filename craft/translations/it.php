...
return array(
    ...
    "Approved US Dests" => "Destinazioni Approvate: United States",
    "Approved EU Dests" => "Destinazioni Approvate: Europe",
    "Purchase" => "Acquistare",
    "Logout" => "Log out",
    "Login" => "Login",
    "Welcome" => "Benvenuto",
    "No Items" => "Non ci sono aticoli nel tuo carrello. Aggiungi un prodotto",
    ...
    "Notify me when this wine becomes available again" => "Notifica mi quando l'articolo sarà disponibile",
